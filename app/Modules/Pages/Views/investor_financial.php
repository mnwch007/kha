<div class="p7main_cnt_two wow fadeIn" id="cnt2">
            ...
            <div class="mobile_link mt-4 d-block   d-lg-none">
                <div class="dropdown">
                    <button
                        ...
                        aria-expanded="false"
                        >
                            <?= lang('global_lang.financial_information') ?>
                    </button>
                    <ul
                        class="dropdown-menu"
                        ...
                        >
                        <li>
                            <a class="active" href="#"><?= lang('global_lang.financial_information') ?></a>
                        </li>
                        <?php
                ...
                foreach ($detail_info as $k => $v):
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            if ($v['pdf_file'] != ""):
                                ?>
                                <span><?= FileSizeConvert(filesize(FCPATH . 'uploads/financial/' . $v['pdf_file'])) ?></span>
                                <a href="<?= img_path('financial/' . $v['pdf_file']) ?>" target="_blank"><img src="<?= assets('img/pdf.png') ?>" alt="" /></a>
                                <?php
                            endif;
                            ?>
                        </td>
