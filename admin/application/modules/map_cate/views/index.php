    ...
    var datatable = $('.m_datatable').mDatatable({
        ...
        columns: [
            ...
            // }, {
                ...
                sortable: true,
                template: function(row) {
                    return '<input type="checkbox" class="setActive" value="1" data-id-field="id" data-id="' + row.id + '" data-url="<?php echo base_url(); ?>" data-table="map_category" data-field="active" value="1" ' + (row.active == 1 ? "checked":"") + ' />'
                }
                // basic templating support for column rendering,
                //template: '{{OrderID}} - {{ShipCountry}}',
            }, {
