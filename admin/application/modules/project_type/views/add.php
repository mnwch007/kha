                                    ...
                                    <div class="tab-pane active" id="m_tabs_en" role="tabpanel">
                                        ...
                                        <div class="form-group m-form__group row">
                                            <div class="col-lg-4">
                                                ...
                                                <input type="text" class="form-control m-input" name="type_name_en" placeholder="Project Type" required="required">
                                        ...
                                        <div class="form-group m-form__group row">
                                            <div class="col-lg-4">
                                                ...
                                                <input type="text" class="form-control m-input" data-role="tagsinput" name="type_keyword_en" placeholder="" value="">
                                                <span class="m-form__help">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <input type="text" class="form-control m-input" name="type_detail_en" placeholder="" value="">
                                                <span class="m-form__help">
                                    ...
                                    <div class="tab-pane" id="m_tabs_th" role="tabpanel">
                                        <div class="form-group m-form__group row">
                                            <div class="col-lg-4">
                                                ...
                                                <input type="text" class="form-control m-input" name="type_name_th" placeholder="กรุณากรอกประเภทโครงการ">
                                                <span class="m-form__help">
                                        ...
                                        <div class="form-group m-form__group row">
                                            <div class="col-lg-4">
                                                ...
                                                <input type="text" class="form-control m-input" data-role="tagsinput" name="type_keyword_th" placeholder="" value="">
                                                <span class="m-form__help">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <input type="text" class="form-control m-input" name="type_detail_th" placeholder="" value="">
                                                <span class="m-form__help">
