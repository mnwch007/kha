        ...
        columns: [
            {
                ...
                template: function(row, index) {
                    var textResp = '';
                    if((index + 1) > 1) {
                        textResp += '<button class="btn btn-default btn-sm" onclick="updateSEQ(\'up\', \'projects_type\', \'Sequence\', \'id\', ' + row.id + ' , {});"><i class="fa fa-arrow-up" aria-hidden="true"></i></button>'
                    }
                    if((index + 1) < <?php echo (int) $this->mains->getCountdata('projects_type'); ?>) {
                        textResp += '<button class="btn btn-default btn-sm" onclick="updateSEQ(\'down\', \'projects_type\', \'Sequence\', \'id\', ' + row.id + ' , {});"><i class="fa fa-arrow-down" aria-hidden="true"></i></button>'
                    }
                    return textResp;
                }
            }, {
                ...
                template: function(row) {
                    return '<input type="checkbox" class="setActive" value="1" data-id-field="id" data-id="' + row.id + '" data-url="<?php echo base_url(); ?>" data-table="projects_type" data-field="active" value="1" ' + (row.active == 1 ? "checked":"") + ' />'
                }
                // basic templating support for column rendering,
                //template: '{{OrderID}} - {{ShipCountry}}',
            }, {
