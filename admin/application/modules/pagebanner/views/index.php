        ...
        var datatable = $('.m_datatable').mDatatable({
            ...
            columns: [{
                    ...
                    template: function (row) {
                        return '<img src="../uploads/banner_page/' + row.banner_image + '" class="img-responsive" style="max-width: 250px" />';
                    },
                }, {
                    field: 'banner_key',
                    title: 'Banner Key',
                    ...
                    class: 'text-center',
                    template: function (row) {
                        return '<input type="checkbox" class="setActive" value="1" data-id-field="banner_id" data-id="' + row.banner_id + '" data-url="<?php echo base_url(); ?>" data-table="banners_pages" data-field="active" value="1" ' + (row.active == 1 ? "checked" : "") + ' />'
                    }
                }, {
                    field: 'updated_at',
                    title: 'Updated at',
