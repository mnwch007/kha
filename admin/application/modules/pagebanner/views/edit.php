                                    ...
                                    <div class="tab-pane active" id="m_tabs_th" role="tabpanel">
                                        <div class="form-group m-form__group row">
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" class="form-control m-input" name="banner_key" placeholder="Banner key" value="<?php echo $info_data['banner_key']; ?>">
                                                <span class="m-form__help">
                                                    Please fill the banner key of page
                                                </span>
                                            </div>
                                        </div>    
                                        <div class="form-group m-form__group row">
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" class="form-control m-input" name="banner_title_th" value="<?php echo $info_data['banner_title_th']; ?>">
                                            </div>
                                            <div class="col-lg-6">
                                                <label>
                                                    รายละเอียดแบนเนอร์
                                                </label>
                                                <input type="text" class="form-control m-input" name="banner_detail_th" value="<?php echo $info_data['banner_detail_th']; ?>">
                                            </div>
                                        </div>
<!--                                        <div class="form-group m-form__group row">
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" class="form-control m-input" name="banner_link" value="<?php echo $info_data['banner_link']; ?>">
                                            </div>
                                        </div>-->
                                        ...
                                        <div class="form-group m-form__group row">
                                            <div class="col-lg-6">
                                                ...
                                                <div class="slim" data-force-size="3000,800" data-max-file-size="10" data-label="<i class='la la-cloud-upload' aria-hidden='true' style='font-size: 35px;color: #666;'></i>" data-default-input-name="Image">
                                                    <input type="file" name="Image" accept="image/png, image/jpeg, image/gif, image/bmp, image/*" />
                                                    <?php if ($info_data['banner_image']): ?>
                                                        <img src="<?php echo base_url('../uploads/banner_page/' . $info_data['banner_image']); ?>" />
                                                    <?php endif; ?>
                                                </div>
                                                <span class="m-form__help">
                                                    Image should be (3000x800px file size limit to 3mb)
                                                </span>
                                            </div>
                                            <div class="col-lg-6">
                                                <label>
                                                ...
                                                <div class="slim" data-force-size="700,500" data-max-file-size="10" data-label="<i class='la la-cloud-upload' aria-hidden='true' style='font-size: 35px;color: #666;'></i>" data-default-input-name="Image2">
                                                    ...
                                                    <?php if ($info_data['banner_image_mob']): ?>
                                                        <img src="<?php echo base_url('../uploads/banner_page/' . $info_data['banner_image_mob']); ?>" />
                                                    <?php endif; ?>
                                                </div>
                                                <span class="m-form__help">
                                    ...
                                    <div class="tab-pane" id="m_tabs_en" role="tabpanel">
                                        <div class="form-group m-form__group row">
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" class="form-control m-input" name="banner_title_en" value="<?php echo $info_data['banner_title_en']; ?>">
                                            </div>
                                            <div class="col-lg-6">
                                                <label>
                                                    Banner Detail
                                                </label>
                                                <input type="text" class="form-control m-input" name="banner_detail_en" value="<?php echo $info_data['banner_detail_en']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
