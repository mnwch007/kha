                                    ...
                                    <div class="tab-pane active" id="m_tabs_en" role="tabpanel">      
                                        <div class="form-group m-form__group row">
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" class="form-control m-input" name="name_en" placeholder="Key Name">
                                     ...
                                     <div class="tab-pane" id="m_tabs_th" role="tabpanel">      
                                        <div class="form-group m-form__group row">
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" class="form-control m-input" name="name_th" placeholder="ชื่อคีย์">
                                                <span class="m-form__help">
                                                    กรุณากรอกชื่อคีย์
                                                </span>
                                            </div>
