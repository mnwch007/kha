                    ...
                    <div class="m-portlet">
                        ...
                        <form action="<?php echo base_url($page_url . '/submit'); ?>" method="post" id="submitForm" data-url="<?php echo base_url($page_url . '/edit/' . $edit_id); ?>" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed">
                            ...
                            <div class="m-portlet__body">
                                    ...
                                    <div class="tab-pane active" id="m_tabs_th" role="tabpanel">
                                        <div class="form-group m-form__group row">
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" class="form-control m-input" name="title_th" value="<?php echo $info_data['title_th']; ?>">
                                            </div>
                                            <div class="col-lg-6">
                                                <label>
                                                    รายละเอียด
                                                </label>
                                                <input type="text" class="form-control m-input" name="short_detail_th" value="<?php echo $info_data['short_detail_th']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- FOR ENG -->
                                    <div class="tab-pane" id="m_tabs_en" role="tabpanel">
                                        <div class="form-group m-form__group row">
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" class="form-control m-input" name="title_en" value="<?php echo $info_data['title_en']; ?>">
                                            </div>
                                            <div class="col-lg-6">
                                                <label>
                                                    Detail
                                                </label>
                                                <input type="text" class="form-control m-input" name="short_detail_en" value="<?php echo $info_data['short_detail_en']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>

                                <?php if ($info_data['file_link'] && $info_data['file_link'] != ""):
                                    ?>
                                    <div class="form-group m-form__group row">
                                        <div class="col-lg-3 mgb-15">
                                            <div class="img-set">
                                                <div class="center-block" style="text-align: center;background: #000">
                                                    <iframe width="300" height="225" src="<?= convertYoutube($info_data['file_link']) ?>" style="border:0;">
                                                    </iframe>
                                                </div>
                                                <div class="content">
                                                    <div class="pull-left"></div>
                                                    <div class="pull-right">
                                                        <a href="<?php echo base_url($page_url . '/media_delete/' . $edit_id); ?>" class="crm-delete m-portlet__nav-link btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill"><i class="la la-trash"></i></a>
                                                    </div>
                                                </div>
                                ...
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control m-input" id="file_link" name="file_link" value="<?php echo $info_data['file_link']; ?>">
