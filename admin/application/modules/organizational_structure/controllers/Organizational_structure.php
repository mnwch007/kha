...
class Organizational_structure extends MY_Controller {

    var $model_name = 'Organizational_structure_model';
    var $page_title = "โครงสร้างองค์กร";
    var $page_view = "organizational_structure";
    ...
    public function submit() {
        ...
        $this->db->update('organizational_structure', $insDB);
