                            ...
                            <div class="m-portlet__body">
                                        ...
                                        <?php foreach ($gallery_db as $key => $row): ?>
                                            <div class="col-lg-3 mgb-15 gallery_item" data-id="<?php echo $row['id']; ?>">
                                                ...
                                                /* elseif ($row['media_type'] == 1): ?>
                                                  ...
                                                  <a href="<?php echo ($row['file_link'] ? $row['file_link'] : 'javascript:;'); ?>" target="_blank">
                                                  <div class="overlay"></div>
                                                  <img src="<?php echo ($row['file_path']) ? base_url('../uploads/video_gallery/' . $row['file_path']) : base_url('images/hero-play.png'); ?>" class="img-responsive center-block" />
                                                  </a>
                                                  </div>
                                                  <div class="content">
                                                  <div class="pull-left">
                                                  ...
                                                  <?php endif; ?>
                                                  <?php
                                                  elseif ($row['media_type'] == 1 && $row['file_path'] == "" && $row['file_link'] != ""):
                                                  ?>
                                                  <div class="img-set">
                                                  <div class="center-block" style="text-align: center;background: #000">
                                                  <iframe width="300" height="225" src="<?= convertYoutube($row['file_link']) ?>" style="border:0;">
                                                  </iframe>
                                                  </div>
                                                  <div class="content">
                                ...
                                <div class="form-group m-form__group row">
                                    <div class="pull-lg-left">
                                        ...
                                        <div class="col">
                                            <span class="m-switch m-switch--outline m-switch--success">
                                                <label>
                                                    <input type="checkbox" name="video_active" value="1" <?php echo ($info_data_main['video_active'] == 1 ? 'checked="checked"' : ''); ?> />
                                                    <span></span>
                                                </label>
                                            </span>
                                        </div>
                                ...
                                <?php if (count($video_db) > 0): ?>
                                    <div class="form-group m-form__group row">
                                        <?php foreach ($video_db as $key => $row): ?>
                                            <?php if ($row['file_path'] && $row['file_link'] == ""): ?>
                                ...
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" class="form-control m-input" name="name_th" value="<?php echo $video_db[0]['name_th']; ?>">
                                    </div>
                                    <div class="col-lg-6">
                                        <label>
                                            รายละเอียด (TH)
                                        </label>
                                        <input type="text" class="form-control m-input" name="detail_th" value="<?php echo $video_db[0]['detail_en']; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" class="form-control m-input" name="name_en" value="<?php echo $video_db[0]['name_en']; ?>">
                                    </div>
                                    <div class="col-lg-6">
                                        <label>
                                            Detail (EN)
                                        </label>
                                        <input type="text" class="form-control m-input" name="detail_en" value="<?php echo $video_db[0]['detail_en']; ?>">
                                    </div>
                                </div>
                            </div>
