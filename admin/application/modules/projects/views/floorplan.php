        ...
        <div class="m-content">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="m-portlet">
                        <!--begin::Form-->
                        <form action="<?php echo base_url($page_url . '/submit'); ?>" method="post" id="submitForm" data-url="<?php echo base_url($page_url . '/floorplan/' . $edit_id); ?>" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed">
                            <input type="hidden" name="mode" value="<?php echo $act_mode; ?>" />
                            <input type="hidden" name="edit_id" value="<?php echo $edit_id; ?>" />
                            <input type="hidden" name="postact" value="floor_plan" />
                                    ...
                                    <div class="pull-lg-left">
                                        ...
                                        <div class="col">
                                            <span class="m-switch m-switch--outline m-switch--success">
                                                <label>
                                                    <input type="checkbox" name="floorplan_active" value="1" <?php echo ($info_data_main['floorplan_active'] == 1 ? 'checked="checked"':''); ?> />
                                                    <span></span>
                                                </label>
                                            </span>
                                        </div>
                                            ...
                                            <div class="col-lg-3 mgb-15">
                                                <div class="img-set">
                                                    <div class="center-block">
                                                        <a href="<?php echo base_url('../uploads/floorplan/' . $row['plan_image']); ?>" target="_blank"><img src="<?php echo base_url('../uploads/floorplan/' . $row['plan_image']); ?>" class="img-responsive center-block" /></a>
                                                    </div>
                                                    <div class="content">
                                                        <div class="pull-left">
                                ...
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-4">
                                        ...
                                        <span class="m-form__help font-red">
                                            Loop name format "Floor_Plan_1-5.jpg" the program will be gererate 5 rows of Floor Plan (1-5)
                                        </span>
                                    </div>
