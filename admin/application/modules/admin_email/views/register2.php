    ...
    jQuery(document).ready(function () {
        ...
        var datatable = $('.m_datatable').mDatatable({
            ...
            data: {
                ...
                source: {
                    read: {
                        url: '<?php echo base_url($page_url . '/loadRegister2/' . $project_id); ?>',
                        map: function (raw) {
                            // sample data mapping
                            var dataSet = raw;
            ...
            columns: [
                ...
                },
                {
                    ...
                    template: function (row, index, datatable) {
                        ...
                        return '\
                    <a href="' + base_url + '/land_detail/' + row.id + '" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" title="Detail">\
                        <i class="la la-eye"></i>\
                    </a>\
                    <a href="' + base_url + '/landsale_delete/' + row.id + '" class="crm-delete m-portlet__nav-link btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill" title="Delete">\
