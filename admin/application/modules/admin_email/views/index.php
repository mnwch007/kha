            ...
            columns: [
                ...
                },
                {
                    ...
                    template: function (row, index, datatable) {
                        ...
                        return '\
                     <a href="' + base_url + '/edit/' + row.id + '" class="m-portlet__nav-link btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill" title="Email Setting">\
                        <i class="la la-edit"></i>\
                    </a>\
                    <a href="' + base_url + '/register/' + row.id + '" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" title="Registered">\
