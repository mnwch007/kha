                            ...
                            <div class="m-portlet__body">
                                ...
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" class="form-control m-input" name="contact_name" placeholder="กรุณากรอกชื่อสถานที่" required="required">
                                        <span class="m-form__help">
                                ...
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" class="form-control m-input" name="contact_tel" placeholder="กรุณากรอกเบอร์โทร" required="required">
                                        <span class="m-form__help">
                                            กรุณากรอกเบอร์โทร
                                        </span>
                                    </div>
                                    <div class="col-lg-4">
                                        ...
                                        <input type="email" class="form-control m-input" name="contact_email" placeholder="กรุณากรอกอีเมล์ (ถ้ามี)">
                                        <span class="m-form__help">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" class="form-control m-input" name="contact_line" placeholder="กรุณากรอกไอดีไลน์ (ถ้ามี)">
                                        <span class="m-form__help">
                                ...
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" class="form-control m-input" name="latitude" placeholder="กรุณากรอกลติจูตของที่ตั้ง" required="required">
                                        <span class="m-form__help">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" class="form-control m-input" name="longtitude" placeholder="กรุณากรอกลองติจูต (longitude)" required="required">
                                        <span class="m-form__help">
                                ...
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-12">
                                        ...
                                        <textarea class="form-control m-input" name="contact_address" placeholder="กรุณากรอกที่อยู่" required="required"></textarea>
                                        <span class="m-form__help">
                                            กรุณากรอกที่อยู่
                                        </span>
                                    </div>
