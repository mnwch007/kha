                            ...
                            <div class="m-portlet__body">
                                ...
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" class="form-control m-input" name="content_url" id="content_url" value="<?php echo $info_data['content_url']; ?>" placeholder="">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" class="form-control m-input" name="content_keyword" id="content_keyword" value="<?php echo $info_data['content_keyword']; ?>" placeholder="">
                                        <span class="m-form__help">
                                    ...
                                    <div class="tab-pane active" id="m_tabs_en" role="tabpanel">
                                        <div class="form-group m-form__group row">
                                            <div class="col-lg-12">
                                                ...
                                                <input type="text" class="form-control m-input" name="content_title_en" placeholder="Page title" required="required" value="<?php echo $info_data['content_title_en']; ?>" onkeyup="return genURL(this, '#content_url');" />
                                                <span class="m-form__help">
                                        ...
                                        <div class="form-group m-form__group row">
                                            <div class="col-lg-12">
                                                ...
                                                <textarea name="content_html_en" class="form-control ck-editor"><?php echo $info_data['content_html_en']; ?></textarea>
                                                <span class="m-form__help">
                                    ...
                                    <div class="tab-pane" id="m_tabs_th" role="tabpanel">
                                        <div class="form-group m-form__group row">
                                            <div class="col-lg-12">
                                                ...
                                                <input type="text" class="form-control m-input" name="content_title_th" value="<?php echo $info_data['content_title_th']; ?>" placeholder="กรุณากรอกชื่อเพจ" required="required" />
                                                <span class="m-form__help">
                                                    กรุณากรอกชื่อเพจ
                                                </span>
                                            </div>
                                        ...
                                        <div class="form-group m-form__group row">
                                            <div class="col-lg-12">
                                                ...
                                                <textarea name="content_html_th" class="form-control ck-editor"><?php echo $info_data['content_html_th']; ?></textarea>
                                                <span class="m-form__help">
