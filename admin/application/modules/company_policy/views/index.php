            ...
            columns: [
                 ...
                 }, */
                {
                    ...
                    template: function (row) {
                        return '<input type="checkbox" class="setActive" value="1" data-id-field="id" data-id="' + row.id + '" data-url="<?php echo base_url(); ?>" data-table="financial" data-field="active" value="1" ' + (row.active == 1 ? "checked" : "") + ' />'
                    }
                }, {
                    field: 'action',
                    width: 110,
