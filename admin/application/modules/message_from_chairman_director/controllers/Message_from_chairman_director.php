...
class Message_from_chairman_director extends MY_Controller {

    var $model_name = 'Message_from_chairman_director_model';
    var $page_title = "สาส์นจากประธานกรรมการ";
    var $page_view = "message_from_chairman_director";
    ...
    public function submit() {
        ...
        $this->db->update('message_from_chairman_director', $insDB);
