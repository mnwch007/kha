...
class Financial extends MY_Controller {
    ...
    public $model_name = 'Financial_model';
    public $page_title = "Financial";
    public $page_view = "financial";
...
//                    'detail_th' => $detail_th,
                ...
                if (isset($_FILES['pdf_file']['name'])):
                    ...
                    $upload_img = $this->uploads('file_path', '/uploads/financial', 409800, 0, 0, false, 'pdf');
...
//                    'detail_th' => $detail_th,
                ...
                if (isset($_FILES['pdf_file']['name'])):
                    ...
                    $upload_img = $this->uploads('file_path', '/uploads/financial', 409800, 0, 0, false, 'pdf|zip|rar');
                    $update_status = $upload_img['upload_code'];
                    $upload_data = $upload_img['upload_data'];
                    if ($update_status == 0):
                        $upload_data = array(
