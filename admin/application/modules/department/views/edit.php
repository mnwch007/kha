                            ...
                            <div class="m-portlet__body">
                                ...
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" class="form-control m-input" name="department_name" placeholder="กรุณากรอกชื่อหน่วยงาน" value="<?php echo $info_data['department_name']; ?>">
                                ...
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-6">
                                        <label>
                                            กรุณาเลือกรูปหน่วยงาน
                                        </label>
                                        <input type="file" class="form-control m-input" name="department_image" placeholder="เลือกรูปหน่วยงาน">
                                        <span class="m-form__help">
                                            ควรเป็นรูปสี่เหลี่ยมจตุรัส ขนาดไม่เกิน (1000x1000px ขนาดไฟล์ไม่เกิน 1mb)
                                        </span>
                                        <?php if($info_data['department_image']): ?>
                                            <div class="">
                                                <img src="<?php echo base_url('../uploads/logo/' . $info_data['department_image']); ?>" class="img-responsive" style="max-width: 150px;" />
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                </div>
