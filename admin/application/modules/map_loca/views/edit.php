                            ...
                            <div class="m-portlet__body">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <select name="cat_id" class="form-control" requried="requried">
                                            ...
                                            <?php foreach($get_cat as $key => $row): ?>
                                                <option value="<?php echo $row['id']; ?>" <?php echo ($info_data['cat_id'] == $row['id'] ? 'selected':''); ?>><?php echo $row['cat_name_en']; ?> / <?php echo $row['cat_name_th']; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    ...
                                    <div class="tab-pane active" id="m_tabs_en" role="tabpanel">
                                        ...
                                        <div class="form-group m-form__group row">
                                            <div class="col-lg-4">
                                                ...
                                                <input type="text" class="form-control m-input" name="lo_name_en" value="<?php echo $info_data['lo_name_en']; ?>" placeholder="Location name" required="required">
                                                <span class="m-form__help">
                                    ...
                                    <div class="tab-pane" id="m_tabs_th" role="tabpanel">
                                        <div class="form-group m-form__group row">
                                            <div class="col-lg-4">
                                                ...
                                                <input type="text" class="form-control m-input" name="lo_name_th" value="<?php echo $info_data['lo_name_th']; ?>" placeholder="กรุณากรอกชื่อตำแหน่ง">
                                                <span class="m-form__help">
                                ...
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" class="form-control m-input" name="latitude" value="<?php echo $info_data['latitude']; ?>" placeholder="Latitude">
                                        <span class="m-form__help">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" class="form-control m-input" name="longitude" value="<?php echo $info_data['longitude']; ?>" placeholder="Longitude">
                                        <span class="m-form__help">
