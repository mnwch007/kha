        ...
        columns: [
            {
                ...
                template: function(row) {
                    return '<img src="' + base_url + '/../../uploads/maps/' + row.icon + '" />';
                }
            }, {
                field: 'lo_name_en',
                title: 'location name',
                sortable: true,
                template: function(row) {
                    return row.lo_name_en + ' / ' + row.lo_name_th;
                }
            }, {
                field: 'cat_name_en',
                title: 'category name',
            ...
            // }, {
                ...
                sortable: true,
                template: function(row) {
                    return '<input type="checkbox" class="setActive" value="1" data-id-field="id" data-id="' + row.id + '" data-url="<?php echo base_url(); ?>" data-table="map_location" data-field="active" value="1" ' + (row.active == 1 ? "checked":"") + ' />'
                }
                // basic templating support for column rendering,
                //template: '{{OrderID}} - {{ShipCountry}}',
            }, {
