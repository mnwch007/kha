                                    ...
                                    <div class="tab-pane active" id="m_tabs_th" role="tabpanel">      
                                        <div class="form-group m-form__group row">
                                            <div class="col-lg-12">
                                                ...
                                                <textarea class="form-control ck-editor" rows="20" name="detail_th"><?php echo $info_data['detail_th']; ?></textarea>
                                    ...
                                    <div class="tab-pane" id="m_tabs_en" role="tabpanel">      
                                        <div class="form-group m-form__group row">
                                            <div class="col-lg-12">
                                                ...
                                                <textarea class="form-control ck-editor" rows="20" name="detail_en"><?php echo $info_data['detail_en']; ?></textarea>
                                                <span class="m-form__help"></span>
                                            </div>
...
/*    .p7main_right_people h5 {
    ...
    .p7main_right_people_wrapper {
        display: grid;
        grid-template-columns: 180px 180px 180px;
        justify-content: space-between;
    }

    .p7main_right_box_people img {
        display: block;
        width: 140px;
        margin-left: -14px;
    }

    .p7main_right_box_people h6 {
        font-size: 16px;
        font-weight: 600;
        color: #0e79bf;
    }

    .p7main_right_box_people {
        margin-top: 40px;
    }*/
</style>