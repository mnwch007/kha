...
class Board_directors extends MY_Controller {

    var $model_name = 'Board_directors_model';
    var $page_title = "คณะกรรมการบริษัท";
    var $page_view = "board_directors";
    ...
    public function submit() {
        ...
        $this->db->update('board_directors', $insDB);
