                                    ...
                                    <div class="tab-pane active" id="m_tabs_en" role="tabpanel">
                                        <div class="form-group m-form__group row">
                                            <div class="col-lg-12">
                                                ...
                                                <input type="text" class="form-control m-input" name="question_en" placeholder="Question" required="required" />
                                        ...
                                        <div class="form-group m-form__group row">
                                            <div class="col-lg-12">
                                                ...
                                                <textarea name="answer_en" rows="6" class="form-control"></textarea>
                                                <span class="m-form__help">
                                    ...
                                    <div class="tab-pane" id="m_tabs_th" role="tabpanel">
                                        <div class="form-group m-form__group row">
                                            <div class="col-lg-12">
                                                ...
                                                <input type="text" class="form-control m-input" name="question_th" placeholder="กรุณากรอกคำถาม" required="required" />
                                                <span class="m-form__help">
                                                    กรุณากรอกคำถาม
                                                </span>
                                            </div>
                                        ...
                                        <div class="form-group m-form__group row">
                                            <div class="col-lg-12">
                                                ...
                                                <textarea name="answer_th" class="form-control"></textarea>
                                                <span class="m-form__help">
                                                    กรุณากรอกคำตอบ
                                                </span>
                                            </div>
