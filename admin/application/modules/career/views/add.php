                            ...
                            <div class="m-portlet__body">
                                    ...
                                    <div class="tab-pane active" id="m_tabs_en" role="tabpanel">
                                        ...
                                        <div class="form-group m-form__group row">
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" class="form-control m-input" name="job_title_en" onkeyup="return genURL(this, '#url');" placeholder="Job title">
                                                <span class="m-form__help">
                                         ...
                                         <div class="form-group m-form__group row">
                                            <div class="col-lg-6">
                                                ...
                                                <textarea class="form-control" rows="2" name="short_detail_en"></textarea>
                                                <span class="m-form__help">
                                        ...
                                        <div class="form-group m-form__group row">
                                            <div class="col-lg-12">
                                                ...
                                                <textarea class="form-control ck-editor" rows="10" name="job_des_en"></textarea>
                                                <span class="m-form__help">
                                        ...
                                        <div class="form-group m-form__group row">
                                            <div class="col-lg-12">
                                                ...
                                                <textarea class="form-control ck-editor" rows="10" name="qualification_en"></textarea>
                                                <span class="m-form__help">
                                        ...
                                        <div class="form-group m-form__group row">
                                            <div class="col-lg-12">
                                                ...
                                                <textarea class="form-control ck-editor" rows="10" name="other_en"></textarea>
                                                <span class="m-form__help">
                                        ...
                                        <div class="form-group m-form__group row">
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" class="form-control m-input" name="button_name_en" placeholder="" autocomplete="off">
                                                <span class="m-form__help">
                                    ...
                                    <div class="tab-pane" id="m_tabs_th" role="tabpanel">
                                        ...
                                        <div class="form-group m-form__group row">
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" class="form-control m-input" name="job_title_th" placeholder="ตำแหน่งงาน">
                                                <span class="m-form__help">
                                                    กรุณากรอกตำแหน่งงาน
                                                </span>
                                            </div>
                                         ...
                                         <div class="form-group m-form__group row">
                                            <div class="col-lg-6">
                                                ...
                                                <textarea class="form-control" rows="2" name="short_detail_th"></textarea>
                                                <span class="m-form__help">
                                        ...
                                        <div class="form-group m-form__group row">
                                            <div class="col-lg-12">
                                                ...
                                                <textarea class="form-control ck-editor" rows="10" name="job_des_th"></textarea>
                                                <span class="m-form__help">
                                        ...
                                        <div class="form-group m-form__group row">
                                            <div class="col-lg-12">
                                                ...
                                                <textarea class="form-control ck-editor" rows="10" name="qualification_th"></textarea>
                                                <span class="m-form__help">
                                        ...
                                        <div class="form-group m-form__group row">
                                            <div class="col-lg-12">
                                                ...
                                                <textarea class="form-control ck-editor" rows="10" name="other_th"></textarea>
                                                <span class="m-form__help">
                                        ...
                                        <div class="form-group m-form__group row">
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" class="form-control m-input" name="button_name_th" placeholder="" autocomplete="off">
                                                <span class="m-form__help">
                                                    กรุณากรอกชื่อปุ่มกด
                                                </span>
                                            </div>
                                ...
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" class="form-control m-input" name="link" placeholder="Button Link">
                                        <span class="m-form__help">
