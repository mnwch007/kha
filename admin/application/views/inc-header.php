                    ...
                    <div class="m-stack m-stack--ver m-stack--desktop">
                        ...
                        <div class="m-stack__item m-stack__item--fluid m-header-head" id="m_header_nav">
                            ...
                            <a href="" class="m-brand__icon m-brand__toggler m-brand__toggler--left m--visible-desktop-inline-block">
                                <img src="<?php echo base_url('assets/img/kha-logo.png'); ?>" class="center-block img-responsive" style="margin-left: 5px;margin-top: 5px;max-width: 100%; max-height: 60px;" />
                            </a>
